...
import { experienceLabel, profile } from "@/content/site";
...
export function generateMetadata(): Metadata {
  const description = `Vitor Luiz da Cruz (Tinho) é desenvolvedor Full Stack com ${experienceLabel()} de experiência em aplicações web modernas, APIs e produtos em produção, com TypeScript, React, Next.js, Node.js e PostgreSQL.`;
